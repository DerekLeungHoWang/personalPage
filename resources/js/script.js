...
$(document).ready(function () {
  $('.submit').click(function (event) {
    ...
    var name = $('.name').val()
    var email = $('.email').val()
    var option = $('.where').val()
    var message = $('.dropLine').val()
    ...
    //   if(name.length === 0){
    //     event.preventDefault()
    //    statusElm.append(`<div class="alert alert-warning">
    //    <strong>Warning!</strong> Name is invalid
    //  </div>`)
    //   }
...
$(function () {
  setTimeout(function () {
    $('.text-animation').removeClass('hidde-n');
  }, 500);
})
